...
void game_status_widget::show_health() {
    ...
    SDL_Rect dstrect = { m_x + 595, m_y - FONT_Y_DRIFT, texW, texH };
...
void game_status_widget::show_progress() {
    SDL_Rect progress = { m_x + 278, m_y + PROGRESS_BAR_HEIGHT / 2 + PROGRESS_BAR_BORDER_SIZE, PROGRESS_BAR_WIDTH, PROGRESS_BAR_HEIGHT };
...
void game_status_widget::show_boost_speed() {
    ...
    SDL_Rect progress = { m_x + 278, m_y + WIDGET_CELL_SIZE + PROGRESS_BAR_HEIGHT / 2, PROGRESS_BAR_WIDTH, PROGRESS_BAR_HEIGHT };
